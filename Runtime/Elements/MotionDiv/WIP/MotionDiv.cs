...
namespace Roots.WIP
{
    // This is an improved WIP.
    public partial class MotionDiv : RishElement<WIPMotionDivProps, WIPMotionDivState>, IAnimatedElement, IMountingListener, ICustomUnmountListener, IPropsListener<WIPMotionDivProps>
    {
        ...
        void IPropsListener<WIPMotionDivProps>.PropsDidChange(WIPMotionDivProps? prev)
        {
            bool animateDirty;
            bool exitDirty;
            if (prev.HasValue)
        ...
        void IPropsListener<WIPMotionDivProps>.PropsWillChange() { }
    ...
    [RishValueType]
    public struct WIPMotionDivProps
    {
    ...
    [RishValueType]
    public struct WIPMotionDivState
    {
        public DOMDescriptor descriptor;
    }
}