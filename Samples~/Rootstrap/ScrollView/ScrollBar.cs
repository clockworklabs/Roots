                ...
                return FadeDiv.Create(
                    className: new ClassName
                    {
                        Utilities
                            .PositionAbsolute()
                            .Padding1()
                            .Pointer(Props.interactable ? PointerDetectionMode.Rect : PointerDetectionMode.ForceIgnore),
                        Props.direction switch
                        {
                            Direction.Vertical => Utilities
                                .Top0()
                                .Bottom0()
                                .Right0(),
                            Direction.Horizontal => Utilities
                                .Left0()
                                .Right0()
                                .Bottom0(),
                        }
                    ...
                    children: MotionDiv.Create(
                        className: Utilities.FlexGrow1().OverflowHidden(),
                        initial: new Initial
                        {
                            width = false,
                            minWidth = false,
                        ...
                        {
                            FadeDiv.Create(
                                className: Utilities.AbsoluteFill().BackgroundBodyTertiary(),
                                preset: FadeDiv.Preset.Fast,
                                maxOpacity: 0.25f,
                                visible: hovered),
                            Handle.Create(
