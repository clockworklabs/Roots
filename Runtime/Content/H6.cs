...
namespace Roots
{
    public partial class H6 : RishElement<H6Props>
    {
        ...
        public static Element Create(ulong key, string text) => Create(key, new H6Props
        {
        ...
        public static Element Create(ulong key, DOMDescriptor descriptor, string text) => Create(key, new H6Props
        {
            descriptor = descriptor,
            children = Label.Create(text: text)
        });
        public static Element Create(Name name, string text) => Create(0, (DOMDescriptor) name, text);
        public static Element Create(ulong key, Name name, string text) => Create(key, new H6Props
        {
            descriptor = name,
            children = Label.Create(text: text)
        });
        public static Element Create(ClassName className, string text) => Create(0, (DOMDescriptor) className, text);
        public static Element Create(ulong key, ClassName className, string text) => Create(key, new H6Props
        {
            descriptor = className,
            children = Label.Create(text: text)
        });
        public static Element Create(Style style, string text) => Create(0, (DOMDescriptor) style, text);
        public static Element Create(ulong key, Style style, string text) => Create(key, new H6Props
        {
            descriptor = style,
            children = Label.Create(text: text)
        });
        ...
        public static Element Create(ulong key, Name name, ClassName className, string text) => Create(key, new H6Props
        {
        ...
        public static Element Create(ulong key, ClassName className, Style style, string text) => Create(key, new H6Props
        {
            descriptor = new DOMDescriptor {
                className = className,
                style = style
        ...
        public static Element Create(ulong key, Name name, ClassName className, Style style, string text) => Create(key, new H6Props
        {
            descriptor = new DOMDescriptor {
                name = name,
                className = className,
        ...
        // public static Element Create(ulong key, DOMDescriptor descriptor, Utilities utilities, string text) => Create(key, new H6Props
        // {
        //     descriptor = descriptor,
        //     utilities = utilities,
        //     children = Label.Create(text: text)
        ...
        // public static Element Create(ulong key, Name name, Utilities utilities, string text) => Create(key, new H6Props
        // {
        //     descriptor = name,
        //     utilities = utilities,
        //     children = Label.Create(text: text)
        ...
        // public static Element Create(ulong key, ClassName className, Utilities utilities, string text) => Create(key, new H6Props
        // {
        //     descriptor = className,
        //     utilities = utilities,
        //     children = Label.Create(text: text)
        ...
        // public static Element Create(ulong key, Style style, Utilities utilities, string text) => Create(key, new H6Props
        // {
        //     descriptor = style,
        //     utilities = utilities,
        //     children = Label.Create(text: text)
        ...
        //     className = className
        // }, utilities, text);
        // public static Element Create(ulong key, Name name, ClassName className, Utilities utilities, string text) => Create(key, new H6Props
        // {
        //     descriptor = new DOMDescriptor {
        //         name = name,
        //         className = className
        ...
        //     style = style
        // }, utilities, text);
        // public static Element Create(ulong key, ClassName className, Style style, Utilities utilities, string text) => Create(key, new H6Props
        // {
        //     descriptor = new DOMDescriptor {
        //         className = className,
        //         style = style
        ...
        //     style = style
        // }, utilities, text);
        // public static Element Create(ulong key, Name name, ClassName className, Style style, Utilities utilities, string text) => Create(key, new H6Props
        // {
        //     descriptor = new DOMDescriptor {
        //         name = name,
        //         className = className,
