...
namespace Roots
{
    ...
    {
        private delegate void TargetUpdate(Target animate, Target exit);
        
        private event Action<VisualElement> OnChange;
        private event TargetUpdate OnTarget;
        ...
        public void SetTargets(Target animate, Target exit)
        {
            Animate = animate;
            Exit = exit;
            
            OnTarget?.Invoke(animate, exit);
        }
        ...
        private class SleepingState : State
        {
            ...
            {
                Motion.SetInitial(element, Element.GetParent()?.Motion);
        ...
        private class ActiveState : State
        {
            ...
            private void OnTarget(Target animate, Target _) => Motion.To(animate);
