...
//     {
//         private const float ScrollMultiplier = 75;
//         private const float HackThreshold = 0.5f;
//         private const float HackValue = 60;
//         
...
//
//             return Div.Create(
//                 descriptor: Props.descriptor + "pointer-detection",
...
//             if (Mathf.Abs(wheelDelta.x) < HackThreshold)
//             {
//                 wheelDelta.x *= HackValue;
//             }
//             if (Mathf.Abs(wheelDelta.y) < HackThreshold)
//             {
//                 wheelDelta.y *= HackValue;
//             }
//
//             // Pref value is between 0 and 1
//             var sensitivity = Props.scrollWheelSensitivity;
//             var prefsMultiplier = sensitivity switch
//             {
...
//             };
//
//             var delta = ClampDeltaPosition(-wheelDelta * ScrollMultiplier * prefsMultiplier);
//
...
//         [DOMDescriptor]
//         public DOMDescriptor holderDescriptor;
